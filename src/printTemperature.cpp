...
void _printOFFTemperature(Adafruit_GFX &display, int row, char* caption) {
					 ...
					 display.setCursor(18, row+7);
					 display.print("FF");						 	
}

static void printTemperature(Adafruit_GFX &display, double temp, int row, char* caption = "") {
	if (temp == TEMP_OFF) {
